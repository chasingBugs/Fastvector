...
python_timer = Timer("fastvector.python_clip_vector(v, -1, 1, v)", setup=import_string)

naive_cython_timer = Timer(
    "fastvector.naive_cython_clip_vector(v, -1, 1, v)", setup=import_string
)

cython_timer = Timer("fastvector.cython_clip_vector(v, -1, 1, v)", setup=import_string)
