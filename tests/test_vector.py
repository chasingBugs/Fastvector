...
class VectorTests(unittest.TestCase):
    ...
    def test_python_clipping_stupid(self) -> None:
        ...
        vec_2 = VectorND([2, 4, 6, 8, 9, 7, 5])
        self.assertRaises(
            ValueError, computations.python_clip_vector, vec_1, 5, 4, vec_2
        )
    ...
    def test_naive_cython_clipping_stupid(self) -> None:
        ...
        vec_2 = VectorND([2, 4, 6, 8, 9, 7, 5])
        self.assertRaises(
            ValueError, computations.naive_cython_clip_vector, vec_1, 5, 4, vec_2
        )
    ...
    def test_cython_clipping_stupid(self) -> None:
        ...
        vec_2 = VectorND([2, 4, 6, 8, 9, 7, 5])
        self.assertRaises(
            ValueError, computations.cython_clip_vector, vec_1, 5, 4, vec_2
        )
